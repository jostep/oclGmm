...
long ack = 0;	// it's meaning depends on the message;
				// for req_evict, it means size of free space spared
...
long msq_send_req_evict(int client, long size_needed, int block)
{
	struct msg_req msg;
	long size_spared = 0;
	int ret = 0;
